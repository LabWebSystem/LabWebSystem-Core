...
export function WidgetFrame(props: WidgetFrameProps) {
  ...
  return (
    <div className="relative flex h-full flex-col overflow-visible rounded-[1.4rem] border border-slate-200/80 bg-white shadow-[0_18px_48px_-36px_rgba(15,23,42,0.45)]">
      {editMode ? (
        <button
          type="button"
          className="absolute -right-2 -top-2 z-20 rounded-full border border-rose-200 bg-white p-2 text-xs text-rose-500 shadow-[0_12px_24px_-16px_rgba(225,29,72,0.85)] transition hover:border-rose-300 hover:bg-rose-50 hover:text-rose-600"
